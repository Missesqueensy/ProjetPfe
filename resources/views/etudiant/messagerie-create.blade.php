        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Nouvelle conversation</h4>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('etudiant.messagerie.store') }}">
                        @csrf

                        <div class="mb-3">
                            <label for="participants" class="form-label">Destinataires</label>
                            <select multiple class="form-select" id="participants" name="participants[]" required
                                    data-placeholder="Sélectionnez un ou plusieurs étudiants">
                                @foreach($etudiants as $etudiant)
                                    <option value="{{ $etudiant->id_etudiant }}">
                                        {{ $etudiant->nom }} {{ $etudiant->prénom }} ({{ $etudiant->email }})
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('etudiant.messagerie.index') }}" class="btn btn-outline-secondary">
...
<!-- Optionnel: Ajouter Select2 pour une meilleure sélection -->
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
<script>
    $(document).ready(function() {
        $('#participants').select2({
            placeholder: "Sélectionnez un ou plusieurs étudiants",
            allowClear: true
        });
    });
</script>
